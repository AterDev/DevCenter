...
public static class StoreServicesExtensions
{
    public static void AddDataStore(this IServiceCollection services)
    {
        ...
        services.AddScoped(typeof(GitLabCommitQueryStore));
        services.AddScoped(typeof(GitLabProjectQueryStore));
        services.AddScoped(typeof(GitLabUserQueryStore));
        ...
        services.AddScoped(typeof(GitLabCommitCommandStore));
        services.AddScoped(typeof(GitLabProjectCommandStore));
        services.AddScoped(typeof(GitLabUserCommandStore));
