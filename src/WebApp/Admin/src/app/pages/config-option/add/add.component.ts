...
import { ConfigOptionAddDto } from 'src/app/share/models/config-option/config-option-add-dto.model';
...
export class AddComponent implements OnInit {
  ...
  add(): void {
    ...
    const data = this.formGroup.value as ConfigOptionAddDto;
