...
import { ResourceAttributeDefineFilter } from 'src/app/share/models/resource-attribute-define/resource-attribute-define-filter.model';
...
export class IndexComponent implements OnInit {
  ...
  filter: ResourceAttributeDefineFilter;
    ...
    this.service.filter(this.filter)
      .subscribe(res => {
        if (res.data) {
          ...
          this.dataSource = new MatTableDataSource<ResourceAttributeDefineItemDto>(this.data);
        }
        this.isLoading = false;
      });
  }

  deleteConfirm(item: ResourceAttributeDefineItemDto): void {
  ...
  delete(item: ResourceAttributeDefineItemDto): void {
