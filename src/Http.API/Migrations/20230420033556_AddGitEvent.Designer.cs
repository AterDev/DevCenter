...
namespace Http.API.Migrations
{
    ...
    [Migration("20230420033556_AddGitEvent")]
    partial class AddGitEvent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.GitLab.GitLabEvent", b =>
                {
                    b.HasBaseType("Core.Models.EntityBase");
                    ...
                    b.ToTable("GitLabEvents");
                });

            modelBuilder.Entity("Core.Entities.GitLab.GitLabProject", b =>
                {
                    b.HasBaseType("Core.Models.EntityBase");
            ...
            modelBuilder.Entity("Core.Entities.GitLab.GitLabUser", b =>
                {
                    b.HasBaseType("Core.Models.EntityBase");
            ...
            modelBuilder.Entity("Core.Entities.GitLab.GitLabEvent", b =>
                {
                    b.HasOne("Core.Entities.GitLab.GitLabProject", "Project")
                        .WithMany("Commits")
                        .HasForeignKey("ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Entities.GitLab.GitLabUser", "User")
                        .WithMany("Commits")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
